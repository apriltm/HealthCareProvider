    ...
    <form id="form1" runat="server">
        <div><div class="header">Welcome, !</div>
            <div class="container"><h1>MAIN MENU</h1><br /><br />
                ...
                <asp:ImageButton runat="server" ID="ImageButton2" ImageUrl="https://cdn0.iconfinder.com/data/icons/typicons-2/24/th-list-64.png" PostBackUrl="~/HealthRecord.aspx" title="View Prescriptions" align="center" style="margin-top: -50px; margin-left: 650px; padding-left: 25px; position: absolute;" />
